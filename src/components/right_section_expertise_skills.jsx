...
const RightSectionExpertiseSkills = () => {
  return (
    <div className="bg-white shadow-xl rounded-lg p-6 max-w-lg mx-auto  h-[1000px] border border-gray-200">
      {/* Expertise Section */}
      <h2 className="text-2xl font-semibold text-black mb-4 flex items-center gap-2">
        <Bolt className="w-6 h-6 text-black" /> Expertise & Technical Skills
      </h2>
      ...
      <ul className="grid gap-4 text-gray-800 text-base">
        <li className="flex items-center gap-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              ...
              CSS, developing modern, responsive, and feature-rich applications.
            </p>
          </div>
        </li>
        ...
        <li className="flex items-center gap-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              ...
              machine learning, leveraging insights for smarter decision-making.
            </p>
          </div>
        </li>

        <li className="flex items-center gap-x-3">
          <Bolt className="w-6 h-6 text-black" />
          <div>
        ...
        <li className="flex items-center gap-x-3">
          ...
          <div>
            <strong className="text-black">Software Engineering</strong>
            <p className="text-sm text-gray-700">
              Strong foundation in backend development, database management, and
              session handling, ensuring security and efficiency.
            </p>
          </div>
        </li>
      ...
      <h2 className="text-2xl font-semibold text-black mt-6 mb-4 flex items-center gap-2">
        <FolderKanban className="w-6 h-6 text-black" /> Key Projects &
        Innovations
      </h2>
      ...
      <ul className="grid gap-4 text-gray-800 text-base">
        ...
        <li className="flex items-center gap-x-3">
          <FolderKanban className="w-6 h-6 text-black" />
          <div>
            <strong className="text-black">Queueing System (MERN Stack)</strong>
            <p className="text-sm text-gray-700">
        ...
        <li className="flex items-center gap-x-3">
          <FolderKanban className="w-6 h-6 text-black" />
          <div>
            <strong className="text-black">Advanced Profile Page UI/UX</strong>
            <p className="text-sm text-gray-700">
        ...
        <li className="flex items-center gap-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700">
              Implemented custom messaging for targeted admin-user notifications
              in a CodeIgniter-based system.
            </p>
          </div>
        </li>
      </ul>
